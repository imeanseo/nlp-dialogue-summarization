# ========================================
# v3_train.py (v3.2 수정판)
# Solar/Llama QLoRA Fine-tuning
# ========================================
...
print("=" * 60)
print("v3_train.py - LLM QLoRA Training (v3.2)")
print("=" * 60)
...
# 5. 데이터셋 로드
print("\n📂 데이터셋 로드 중...")
train_df = pd.read_csv('./processed_data_v3/train.csv')
dev_df = pd.read_csv('./processed_data_v3/dev.csv')
