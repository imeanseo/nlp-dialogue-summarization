...
def find_all_typos_and_emotions(input_file='/root/nlp_data/v6_solar_t5/data/augmented/train_v6_perfect_cleaned.csv'):
    """
...
# 실행
if __name__ == "__main__":
    cleaned_df = process_train_data_simple('/root/nlp_data/v6_solar_t5/data/augmented/train_v6_perfect.csv', 'train_cleaned.csv')
